#let default-color = green.lighten(10%) 
...
#let title-slide(content) = {
    ...
    set page(
      background: align(left, rect(height: 1fr,fill: dark-blue)),
    )
...
#let slides(
  ...
  show title: set text(font: "Futura", fill: rgb("1C559C"), size: 1.5em)
  ...
  if title != none {
    ...
    title-slide[
      ...
      //     width: 200pt,
      //     stroke: 1pt,
      //     upper(text(2em, weight: "bold", fill: title-color, title))
      //   ),
      //   float: true,
      //   top,
      //   dx: 130pt,
      ...
      // )
        ...
        place(
          block(
            ...
            align(left,
              upper(
                text(1.2em, weight: "bold", font: "Futura", fill: rgb("3FA3D2"), subtitle)),
            )
          ),
          float: true,
          top,
